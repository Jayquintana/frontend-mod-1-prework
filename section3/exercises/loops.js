...
// EXPLAIN:
//i is logged to the console in this example, i = 0 and the condition is if i < 9. This is going to be used
//to count from 0 to 2, so this loop condition is a counter.
