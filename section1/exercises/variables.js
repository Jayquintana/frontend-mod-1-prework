...
// first var is a name so to give a name variable value, I have to use a string data type that handles letters.
// isHungry is either a yes or no variable which is why I used a Boolean that deals in true or false.
// var numberOfPets is asking for a number so I used an integer data type that uses whole numbers.
